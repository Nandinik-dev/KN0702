...
import com.example.toolrentall.RentalAgreement;
import com.example.toolrentall.Tool;
...
public class RentalAgreementTest {
    ...
    public void testCase2() {
        ...
        assertEquals(2, rental.getChargeDays()); 
    ...
    public void testCase3() {
        ...
        assertEquals(3, rental.getChargeDays());  
    ...
    public void testCase5() {
        ...
        assertEquals(5, rental.getChargeDays()); 
        assertEquals(2.99, rental.getTool().getDailyCharge(), 0.01);
        assertEquals(0, rental.getDiscountPercent(), 0.01);
